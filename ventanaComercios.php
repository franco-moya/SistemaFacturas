...
<body> 
    ...
    <div class="container-fluid"> 
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">    
                <li class="nav-item">
                    <a class="nav-link active" href="index.php">Obras</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active bg-light text-dark rounded" href="ventanaComercios.php">Proveedores</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <button type="button" class="btn text-light" data-bs-toggle="modal" data-bs-target="#modalComercios">
                        Agregar Proveedor
                    </button>
                </li>
            ...
            <ul class="navbar-nav"> 
                <li class="nav-item">
                    <a class="nav-link link-light" href="cerrarSesion.php">Cerrar sesion</a>
                </li>
            </ul>
        ...
        <div class="col-8 offset-md-2 p-4">
                <h2>Proveedores</h2>    
                <div class="row" id="Contenedor_comercios">
    ...
    <?php include ("modalFacturasComercios.php");?>
    <?php include ("modalObras.php");?>
    <?php include ("modalCompradores.php");?>
    <script src="js/gestionarComercios.js?v=<?php echo rand()?>"></script>
